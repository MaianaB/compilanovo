 ...
 * </p>
 * <ul>
 *   <li>{@link com.ufcg.compiladores.go.TIPO#getVariavel <em>Variavel</em>}</li>
 *   <li>{@link com.ufcg.compiladores.go.TIPO#getConstante <em>Constante</em>}</li>
 * </ul>
 *
 * @see com.ufcg.compiladores.go.GoPackage#getTIPO()
 * @model
 * @generated
 */
public interface TIPO extends EObject
{
   ...
   * @see #setVariavel(Var)
   * @see com.ufcg.compiladores.go.GoPackage#getTIPO_Variavel()
  ...
  /**
   * Sets the value of the '{@link com.ufcg.compiladores.go.TIPO#getVariavel <em>Variavel</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setConstante(Const)
   * @see com.ufcg.compiladores.go.GoPackage#getTIPO_Constante()
   * @model containment="true"
   * @generated
   */
  Const getConstante();
  ...
  /**
   * Sets the value of the '{@link com.ufcg.compiladores.go.TIPO#getConstante <em>Constante</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
