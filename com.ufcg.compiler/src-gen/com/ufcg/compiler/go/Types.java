 ...
 * </p>
 * <ul>
 *   <li>{@link com.ufcg.compiler.go.Types#getBasic <em>Basic</em>}</li>
 *   <li>{@link com.ufcg.compiler.go.Types#getArray <em>Array</em>}</li>
 * </ul>
 *
 * @see com.ufcg.compiler.go.GoPackage#getTypes()
 * @model
 * @generated
 */
public interface Types extends EObject
{
   ...
   * @see com.ufcg.compiler.go.GoPackage#getTypes_Basic()
  ...
  /**
   * Sets the value of the '{@link com.ufcg.compiler.go.Types#getBasic <em>Basic</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.ufcg.compiler.go.GoPackage#getTypes_Array()
   * @model containment="true"
   * @generated
   */
  ArrayType getArray();
  ...
  /**
   * Sets the value of the '{@link com.ufcg.compiler.go.Types#getArray <em>Array</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
