 ...
 * </p>
 * <ul>
 *   <li>{@link com.ufcg.compiler.go.impl.BOOLEAN_VALUEImpl#getVerdadeiro <em>Verdadeiro</em>}</li>
 *   <li>{@link com.ufcg.compiler.go.impl.BOOLEAN_VALUEImpl#getFalso <em>Falso</em>}</li>
 * </ul>
 *
 * @generated
 */
