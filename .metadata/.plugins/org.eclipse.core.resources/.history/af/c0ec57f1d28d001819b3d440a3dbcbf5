 ...
 * </p>
 * <ul>
 *   <li>{@link com.ufcg.compiler.go.ArrayType#getQtd <em>Qtd</em>}</li>
 *   <li>{@link com.ufcg.compiler.go.ArrayType#getBasic <em>Basic</em>}</li>
 * </ul>
 *
 * @see com.ufcg.compiler.go.GoPackage#getArrayType()
 * @model
 * @generated
 */
public interface ArrayType extends EObject
{
   ...
   * @see #setQtd(String)
   * @see com.ufcg.compiler.go.GoPackage#getArrayType_Qtd()
   * @model
   * @generated
   */
  String getQtd();
  ...
  /**
   * Sets the value of the '{@link com.ufcg.compiler.go.ArrayType#getQtd <em>Qtd</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.ufcg.compiler.go.GoPackage#getArrayType_Basic()
  ...
  /**
   * Sets the value of the '{@link com.ufcg.compiler.go.ArrayType#getBasic <em>Basic</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
