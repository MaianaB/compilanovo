 ...
 * </p>
 * <ul>
 *   <li>{@link com.ufcg.compiler.go.impl.SignatureDelImpl#getTipoDecl <em>Tipo Decl</em>}</li>
 *   <li>{@link com.ufcg.compiler.go.impl.SignatureDelImpl#getId <em>Id</em>}</li>
 *   <li>{@link com.ufcg.compiler.go.impl.SignatureDelImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
