 ...
 * </p>
 * <ul>
 *   <li>{@link com.ufcg.compiler.go.ArrayValue#getLit <em>Lit</em>}</li>
 * </ul>
 *
 * @see com.ufcg.compiler.go.GoPackage#getArrayValue()
 * @model
 * @generated
 */
public interface ArrayValue extends EObject
{
   ...
   * @see com.ufcg.compiler.go.GoPackage#getArrayValue_Lit()
  ...
  /**
   * Sets the value of the '{@link com.ufcg.compiler.go.ArrayValue#getLit <em>Lit</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
